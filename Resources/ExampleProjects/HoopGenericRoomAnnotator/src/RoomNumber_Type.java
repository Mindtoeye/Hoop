...
public class RoomNumber_Type extends Annotation_Type {
         ...
         * @modifiable
         */
        public final static boolean featOkTst = JCasRegistry.getFeatOkTst("RoomNumber");
        ...
        public String getBuilding(int addr) {
                if (featOkTst && casFeat_building == null) jcas.throwFeatMissing("building", "RoomNumber");

 ...
 */
public class MultiSplitLeaf extends MultiSplitNode 
{
	private String name = "";
	 ...
	 */
	public MultiSplitLeaf () 
	{ 
    	setClassName ("MultiSplitLeaf");
    	debug ("MultiSplitLeaf ()");			
	}
	 ...
	 */
	public MultiSplitLeaf(String name) 
	{
	    if (name == null) 
	    {
	...
	{
	    StringBuffer sb = new StringBuffer("MultiSplitLeaf");
	    sb.append(" \"");
	    sb.append(getName());
	    sb.append("\""); 
	    sb.append(" weight=");

 ...
 * tiles.
 */
public class MultiSplitSplitter extends MultiSplitNode 
{
	private List<MultiSplitNode> children = Collections.emptyList();
	private boolean rowLayout = true;

	/**
	 * 
	 */
	public MultiSplitSplitter ()
	{
    	setClassName ("MultiSplitSplitter");
    	debug ("MultiSplitSplitter ()");		
	}	
	/**
	 ...
	 * @see #setChildren
	 */
	public List<MultiSplitNode> getChildren() 
	{ 
	    return new ArrayList<MultiSplitNode>(children);
	}
	/**
	 ...
	 */
	public void setChildren(List<MultiSplitNode> children) 
	{
	    if (children == null) 
	    {
	    ...
	    for(MultiSplitNode child : this.children) 
	    {
	    	child.setParent(null);
	    }
	    
	    this.children = new ArrayList<MultiSplitNode>(children);

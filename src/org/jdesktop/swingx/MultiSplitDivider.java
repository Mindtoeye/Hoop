 ...
 */
public class MultiSplitDivider extends MultiSplitNode 
{
	/**
	 * 
	 */
	public MultiSplitDivider ()
	{
    	setClassName ("MultiSplitDivider");
    	debug ("MultiSplitDivider ()");		
	}	
	/**
	...
	{
	    return "MultiSplitDivider " + getBounds().toString();
	}
}

 ...
 */
public class MultiSplitNode extends HoopRoot
{	         	
	private MultiSplitSplitter parent = null;  
    private Rectangle bounds = new Rectangle();
    private double weight = 0.0;

    public MultiSplitNode ()
    {
    	setClassName ("MultiSplitNode");
    	debug ("MultiSplitNode ()");
    }    
    /** 
	 * Returns the Split parent of this MultiSplitNode, or null.
	 *
	 * @return the value of the parent property.
	 * @see #setParent
	 */
	public MultiSplitSplitter getParent() 
	{ 
		return parent; 
	}
	/**
	 * Set the value of this MultiSplitNode's parent property.  The default
	 * value of this property is null.
	 * 
	 * @param parent a Split or null
	 * @see #getParent
	 */
	public void setParent(MultiSplitSplitter parent) 
	{
	    this.parent = parent;
	}	
	/**
	 * Returns the bounding Rectangle for this MultiSplitNode.
	 * 
	 ...
	 * 
	 */
	public MultiSplitNode siblingAtOffset(int offset) 
	{
		MultiSplitSplitter parent = getParent();
	    ...
	    List<MultiSplitNode> siblings = parent.getChildren();
	...
	/** 
	 * Return the MultiSplitNode that comes after this one in the parent's
	 * list of children, or null.  If this node's parent is null,
	 * or if it's the last child, then return null.
	 * 
	 * @return the MultiSplitNode that comes after this one in the parent's list of children.
	 * @see #previousSibling
	 * @see #getParent
	 */
	public MultiSplitNode nextSibling() 
	{
	    return siblingAtOffset(+1);
	}
	/** 
	 * Return the MultiSplitNode that comes before this one in the parent's
	 * list of children, or null.  If this node's parent is null,
	 * or if it's the last child, then return null.
	 * 
	 * @return the MultiSplitNode that comes before this one in the parent's list of children.
	 * @see #nextSibling
	 * @see #getParent
	 */
	public MultiSplitNode previousSibling() 
	{
	    return siblingAtOffset(-1);
	}
}

 ...
 */
public class Parser extends HoopRoot implements ParserConstants 
{
   ...
   *         something in the JDK is broken...
   */
  public boolean parse(String aString) throws ParseException 
  {
	  debug ("parser (String)");
	  
	  StringReader ins = new StringReader(aString.trim ());
  ...
  */
  ...
  final public void graph_attrib_assign() throws ParseException {
                              Token id = null; String value = null;
  ...
  final public void single_node() throws ParseException {
                      Node n=null; Hashtable<String,String> ht=null;
    n = node();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case SPACE:
      label_35:
  ...
  final public Id id() throws ParseException {
            Token id = null; Token text=null;Id i = new Id();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case ID:
      id = jj_consume_token(ID);
                    i.setId(id.image); {if (true) return i;}
      break;
    case STR:
      text = jj_consume_token(STR);
                        if(text!=null) {
  ...
  final public String value() throws ParseException {
    ...
    case STR:
      text = jj_consume_token(STR);
                {if (true) return text.image.substring(1, text.image.length()-1);}
      break;
    case NUMBER:
  ...
  final private boolean jj_3R_82() {
    ...
    while (true) {
      xsp = jj_scanpos;
      if (jj_scan_token(19)) { jj_scanpos = xsp; break; }
    }
    return false;
  }
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0x7088000,0x7088001,0x88000,0x88000,0x88000,0x80000,0x4000000,0x80000,0x80000,0x3000000,0x80000,0x18000000,0x80000,0x80000,0x3a4f0000,0x80000,0x80000,0x3a478800,0x3a4f8800,0x38000000,0x8800,0x80000,0x80000,0x80000,0x80000,0x38000000,0x80000,0x80000,0x80000,0x80000,0x80000,0x80000,0x38000000,0x600,0x100000,0x600,0x80000,0x80000,0x80000,0x80000,0x38000000,0x80000,0x80000,0x100000,0x80000,0x80000,0x100000,0x80000,0x80000,0x100000,0x2060000,0x80000,0x10000,0x80000,0x18000000,0x8000,0x8000,0x80000,0x80000,0x3a470000,0x80000,0x80000,0x80000,0x80000,0x8800,0x8800,0x80000,0x80000,0x80000,0x80000,0x80000,0x80000,0x1000,0x80000,0x80000,0x100000,0x80000,0x80000,0x100000,0x8000,0x80000,0x8000,0x80000,0x10000000,0x10000000,0x80000,0x80000,0x80000,0x80000,0x80000,0x2000,0x8000,0x80000,0x80000,0x80000,0x80000,0x30000000,0x38000000,0x18000000,0x38000000,};
   }

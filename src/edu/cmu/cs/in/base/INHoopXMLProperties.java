 ...
 */
public class INHoopXMLProperties extends INHoopXMLProperty
{
	private ArrayList <INHoopXMLProperty> properties;
  
	/**
	 *  
	 */
	public INHoopXMLProperties () 
	{
		setClassName ("INHoopXMLProperties");
		//debug ("INHoopXMLProperties ()");
  
		properties=new ArrayList <INHoopXMLProperty> ();
	}
	/**
	 *  
	 */
	...
	{
		INHoopXMLProperty prop=new INHoopXMLProperty ();
	...
	public void setProperty (String a_property,String a_value)
	{
		...
		{
			INHoopXMLProperty prop=(INHoopXMLProperty) properties.get (i);

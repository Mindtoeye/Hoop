 ...
 * We build on the data organization of the HoopKVTable and we add the
...
{    	
	 ...
	 *
	 */
    public HoopKVClassificationTable () 
    {
	 ...
	 *
	 */
    public HoopKVClassificationTable (String [] colHeaders) 
    {    	
    	features=new ArrayList<String> ();
     ...
     */
    public ArrayList <HoopKV> getColumn (String aCol)
    {

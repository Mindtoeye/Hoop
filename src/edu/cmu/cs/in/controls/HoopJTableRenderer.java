 ...
 * 
 */
public class HoopJTableRenderer extends JComponent
{
	private static final long serialVersionUID = 2106746763664760745L;
	public static final String IMAGE_PATH = "/assets/images/";
	protected static HoopJTableRenderer dragSource = null;
	...
	public HoopJTableRenderer (final Object cell,final mxGraphComponent graphContainer)
	{
		...
		JLabel icon = new JLabel(new ImageIcon(HoopJTableRenderer.class.getResource(IMAGE_PATH + "preferences.gif")));
		...
		JButton button = new JButton(new AbstractAction("", new ImageIcon(HoopJTableRenderer.class.getResource(IMAGE_PATH + "minimize.gif")))
		{

			public void actionPerformed(ActionEvent e)
			{
				graph.foldCells(graph.isCellCollapsed(cell),false,new Object[] { cell });
				((JButton) e.getSource()).setIcon(new ImageIcon(HoopJTableRenderer.class.getResource(IMAGE_PATH	+ ((graph.isCellCollapsed(cell)) ? "maximize.gif" : "minimize.gif"))));
			}
		});
		...
		label = new JLabel(new ImageIcon(HoopJTableRenderer.class.getResource(IMAGE_PATH + "resize.gif")));
	 ...
	 * 
	 */
	public class HoopInternalTable extends JTable implements DropTargetListener
	{
		/**
		 * 
		 */
		...
		public HoopInternalTable()
		{
			...
			for (int i = 0; i < 30; i++)
			{
				...
				data[i][1] = "Column " + i;
				data[i][2] = (Math.random() > 0.5) ? new ImageIcon(HoopJTableRenderer.class.getResource(IMAGE_PATH	+ "preferences.gif")) : null;
				data[i][3] = (Math.random() > 0.5) ? new ImageIcon(HoopJTableRenderer.class.getResource(IMAGE_PATH	+ "preferences.gif")) : null;
				data[i][4] = (Math.random() > 0.5) ? new ImageIcon(HoopJTableRenderer.class.getResource(IMAGE_PATH	+ "preferences.gif")) : null;
			}
			...
			setTransferHandler(new TransferHandler()
			{
				...
				protected Transferable createTransferable(JComponent c)
				{
					...
					dragSource = HoopJTableRenderer.this;
		...
		public void dragOver(DropTargetDragEvent e)
		{
			if (!((mxGraphTransferHandler) graphContainer.getTransferHandler())
					.isLocalDrag()
					&& HoopJTableRenderer.this != dragSource)
			{
		...
		public void drop(DropTargetDropEvent e)
		{
			if (dragSource != null)
			{
				...
				Object edge = graph.insertEdge(null, null, null,
						dragSource.cell, HoopJTableRenderer.this.cell, "sourceRow="
	 ...
	 * 
	 */
	public static HoopJTableRenderer getVertex(Component component)
	{
		while (component != null)
		{
			if (component instanceof HoopJTableRenderer)
			{
				return (HoopJTableRenderer) component;
			}

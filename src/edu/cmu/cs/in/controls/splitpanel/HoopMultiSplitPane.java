/*
 * $Id: HoopMultiSplitPane.java,v 1.15 2005/10/26 14:29:54 hansmuller Exp $
 *
 ...
 * @author Hans Muller
 */
public class HoopMultiSplitPane extends HoopJPanel 
{
    ...
    private HoopMultiSplitDivider dragDivider = null;
    ...
    /**
     * Creates a HoopMultiSplitPane with it's LayoutManager set to 
     * to an empty HoopMultiSplitLayout.
     */
    public HoopMultiSplitPane() 
    {    	
    	super (new HoopMultiSplitLayout());
    	
		setClassName ("HoopMultiSplitPane");
		debug ("HoopMultiSplitPane ()");	    	
     ...
     * to MutliSplitLayout.
     * 
     * @return this HoopMultiSplitPane's layout manager
     * @see java.awt.Container#getLayout
     * @see #setModel
     */
    public final HoopMultiSplitLayout getMultiSplitLayout() 
    {
    	return (HoopMultiSplitLayout)getLayout();
    }

    /** 
     * A convenience method that sets the HoopMultiSplitLayout model.
     * Equivalent to <code>getMultiSplitLayout.setModel(model)</code>
     * 
     * @param model the root of the HoopMultiSplitLayout model
     * @see #getMultiSplitLayout
     * @see HoopMultiSplitLayout#setModel
     */
    public final void setModel(HoopMultiSplitNode model) 
    {
    	debug ("setModel ()");
     ...
     */
    public HoopMultiSplitDivider activeDivider() 
    {
    	return dragDivider;
    }
    ...
    public static abstract class DividerPainter 
    {
    	 ...
    	 */
    	public abstract void paint(Graphics g, HoopMultiSplitDivider divider);
    }

    private class DefaultDividerPainter extends DividerPainter 
    {
    	public void paint(Graphics g, HoopMultiSplitDivider divider) 
    	{
    ...
    /** 
     * The DividerPainter that's used to paint Dividers on this HoopMultiSplitPane.
     ...
     * HoopMultiSplitPane.  The default DividerPainter only draws
     ...
     * the HoopMultiSplitPane's children have been rendered so that 
    ...
    protected void paintChildren(Graphics g) 
    {
    	...
    	if ((dp != null) && (clipR != null)) 
    	{
            ...
            try 
            {
            	HoopMultiSplitLayout msl = getMultiSplitLayout();
            	for(HoopMultiSplitDivider divider : msl.dividersThatOverlap(clipR)) 
            	{
    ...
    private void startDrag(int mx, int my) 
    {
    	...
    	HoopMultiSplitLayout msl = getMultiSplitLayout();
    	HoopMultiSplitDivider divider = msl.dividerAt(mx, my);
    	
    	if (divider != null) 
    	{    		
    		HoopMultiSplitNode prevNode = divider.previousSibling();
    		HoopMultiSplitNode nextNode = divider.nextSibling();
    ...
    private void updateCursor(int x, int y, boolean show) 
    {
    	...
    	if (show) 
    	{
    		HoopMultiSplitDivider divider = getMultiSplitLayout().dividerAt(x, y);
    		if (divider != null) 
    		{
    ...
    public AccessibleContext getAccessibleContext() 
    {
        ...
        {
            accessibleContext = new AccessibleHoopMultiSplitPane();
        }
	 ...
	 * 
	 */
    protected class AccessibleHoopMultiSplitPane extends AccessibleJPanel 
    {

 ...
 * 
 */
public class HoopXPathFeatureEditor extends HoopEmbeddedJPanel implements ActionListener, TableModelListener
{
	private static final long serialVersionUID = 1L;
	
    //private JFileChooser fc=null;
	private HoopJTable featureList=null;
	...
	private HoopBase propContainer=null;
	
	/**
	 * 
	 */
	public HoopXPathFeatureEditor (HoopBase aPropContainer)  
    {
		setClassName ("HoopXPathFeatureEditor");
		debug ("HoopXPathFeatureEditor ()");
	    ...
	    addFeature.setIcon(HoopLink.getImageByName("gtk-add.png"));
	    ...
	    deleteFeature.setIcon(HoopLink.getImageByName("delete.gif"));
	 ...
	 * 
	 */
	public HoopBase getPropContainer() 
	{
	 ...
	 * 	
	 */
	public void setPropContainer(HoopBase propContainer) 
	{

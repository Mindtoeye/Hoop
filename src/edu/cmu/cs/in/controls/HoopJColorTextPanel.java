 ...
 *
 */
public class HoopJColorTextPanel extends JPanel implements ListCellRenderer
{
	private static final long serialVersionUID = 1L;
	public HoopVisualSentence featureSet=null;
	...
	{
		HoopRoot.debug ("HoopFeatureMatrixPane",aMessage);	
	}	
	/**
	 *
	 */	
	public HoopJColorTextPanel ()
	{
		super();
		
		debug ("HoopFeatureMatrixPane ()");		
	...
	{		
		featureSet=(HoopVisualSentence) value;
	...
	public void paint (Graphics g) 
	{
		...
		HoopVisualClass aClass=featureSet.getClassification();
		if (aClass!=null)
		{
		...
		ArrayList<HoopVisualFeature> featureList=featureSet.getFeatures ();
		
		int textHeight=10;
		
		for (int i=0;i<featureList.size();i++)
		{			
			HoopVisualFeature feature=(HoopVisualFeature) featureList.get(i);
...
/*	
	public void paint (Graphics g) 
	{
		...
		Font font=new Font("Verdana",Font.PLAHoop,12);
...
*/		
	...
	private String featureSetToString (ArrayList<HoopVisualFeature> featureList)
	{
	 ...
	 */
	@SuppressWarnings("unused")
	private void featureSetToIntensity (AttributedString visualString,ArrayList<HoopVisualFeature> featureList)
	{

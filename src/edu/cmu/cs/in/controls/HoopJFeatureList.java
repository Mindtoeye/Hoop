...
import edu.cmu.cs.in.controls.HoopVisualFeatureVisualizer;
import edu.cmu.cs.in.controls.base.HoopJPanel;
//import edu.cmu.cs.in.controls.base.HoopZoomedJPanel;

public class HoopJFeatureList extends HoopJPanel implements ActionListener, MouseListener
{
    ...
    private ArrayList <HoopVisualFeatureVisualizer> dependends=null;
    private HoopVisualClass assignedClass=null;
    
	/**
	 *
	 */	
	public HoopJFeatureList ()
	{
		super();
		
		debug ("HoopJFeatureList ()");		
	 ...
	 *
	 */	
	public HoopJFeatureList (Boolean showSearch)
	{
		super();
	...
	public void updateDependends ()
	{
		...
		{
			HoopVisualFeatureVisualizer dep=dependends.get(i);
	...
	public void modelFromArray (String [] list)
	{
		...
		{
			HoopVisualFeature item=new HoopVisualFeature ();
	...
	private void filterModel ()
	{
		...
		else
		{
        	...
        	{
        	    HoopVisualFeature item=(HoopVisualFeature) originalModel.getElementAt (i);
	...
	public void selectAll ()
	{
    	...
    	{
    	    HoopVisualFeature item=(HoopVisualFeature) filteredModel.getElementAt (i);

 ...
 *
 */
public class INHoopStatistics extends INEmbeddedJPanel implements ActionListener
{	
	 ...
	 * 
	 */	
	public INHoopStatistics()
	{
		//super("Console", true, true, true, true);
		
		setClassName ("INHoopStatistics");
		debug ("INHoopStatistics ()");

 ...
 * 
 */
public class HoopVocabularyEditor extends HoopEmbeddedJPanel implements ActionListener
{
	private static final long serialVersionUID = 1L;
	
	private HoopJFeatureList positionList=null;
    private JFileChooser fc=null;
	
	/**
	 * 
	 */
	public HoopVocabularyEditor ()  
    {
    	//super("Vocabulary Editor", true, true, true, true);
    	
		positionList=new HoopJFeatureList ();
		...
		if (button.getText().equals("Load Vocabulary"))
		{
	        ...
	        if (returnVal==JFileChooser.APPROVE_OPTION) 
	        {
	        	...
	        	{          	
	        		...
	        		ArrayList<String> tempFiles=HoopLink.fManager.listFiles (file.getPath());
	        		...
	        		for (int i=0;i<tempFiles.size();i++)
	        		{
	        			...
	        			{	
	        				...
	        				HoopLink.posFiles.add(splitter [0]);
	        			}
	        		}
	        		
	        		positionList.modelFromArrayList (HoopLink.posFiles);   	
	        		positionList.selectAll();
	           	
	        		debug ("Found " + HoopLink.posFiles.size() + " position list files");
	        	}
	        }						
		}		
	}  

...
{	
	 ...
	 * 
	 */	  
	public INHoopTabDraggable() 
	{
		super();
		
		if (useBasicStyle==false)
		{
			this.setUI(new INHoopTabUI());
		}	
	    ...
	    final Transferable t = new Transferable() 
	    {
	    	...
	    	{
	    		return INHoopTabDraggable.this;
	    	}
	    	/**
	    	 * 	
	    	 */
	...
	/**
	  * Let the UI style class do this instead if we can (INHoopTabUI)
	  */
	@Override 
	...
	private void autoScrollTest(Point glassPt) 
	{
	  ...
	  {
		  Point tabPt = SwingUtilities.convertPoint (glassPane, glassPt, INHoopTabDraggable.this);

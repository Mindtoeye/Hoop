 ...
 * 
 */	
public class HoopSheetCellColor extends HoopJPanel implements TableCellRenderer 
{
	 ...
	 * 
	 */	    
    public HoopSheetCellColor (boolean isBordered) 
    {
    	setClassName ("HoopSheetCellColor");
        debug ("HoopSheetCellColor ()");
                            						...
                            						int column) 
    {
		...
		*/	
    	...
    	if (aValue instanceof String)
    	{
            ...
            newColor=(Color) HoopColorUtil.parse(safety);
    	...
    	else
    	{
    		...
    		object=(HoopSerializable) value.getEntry();
    	    	
    		debug ("Parsing: " + object.getValue());
    	
    		colorLabel.setText(object.getValue());
    	
    		newColor=(Color) HoopColorUtil.parse(object.getValue());
    		colorPicker.setBackground(newColor);
    		colorPicker.repaint();

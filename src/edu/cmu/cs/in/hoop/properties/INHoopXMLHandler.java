 ...
 * 
 */
public class INHoopXMLHandler extends DefaultHandler 
{
	...
	//static INHoopXMLViewer treeViewer = null;
    ...
    {
    	INBase.debug ("INHoopXMLHandler",aMessage);
    }		
	/**
	 * 
	 */			
	...
	{
		treeViewer = new INHoopXMLViewer();
		// treeViewer.xmlSetUp();
		treeViewer.createUI();

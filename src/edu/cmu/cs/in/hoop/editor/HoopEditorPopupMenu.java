...
public class HoopEditorPopupMenu extends JPopupMenu
{
	/**
	 * 
	 */
	...
	public HoopEditorPopupMenu(HoopBasicGraphEditor editor)
	{
		...
		HoopEditorMenuBar.populateFormatMenu(menu, editor);

		// Creates the shape menu
		menu = (JMenu) add(new JMenu(mxResources.get("shape")));

		HoopEditorMenuBar.populateShapeMenu(menu, editor);

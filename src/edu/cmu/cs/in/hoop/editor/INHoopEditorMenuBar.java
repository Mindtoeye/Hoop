...
public class INHoopEditorMenuBar extends JMenuBar
{
	 ...
	 */
	public static void populateShapeMenu(JMenu menu, INHoopBasicGraphEditor editor)
	{
	 ...
	 */
	public static void populateFormatMenu(JMenu menu, INHoopBasicGraphEditor editor)
	{

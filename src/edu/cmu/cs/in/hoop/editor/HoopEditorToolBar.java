...
import edu.cmu.cs.in.hoop.editor.HoopEditorActions.FontStyleAction;
 ...
 */
public class HoopEditorToolBar extends JToolBar
{
	private static final long serialVersionUID = -1L;
	private boolean ignoreZoomChange = false;
	private HoopGraphEditor editor=null;

	/**
	 * 
	 */
	public HoopEditorToolBar()
	{
	...
	{
		HoopRoot.debug("HoopEditorToolBar",aMessage);
	}
	/** 
	 * @param editor
	 * @param orientation
	 */
	public void create (HoopGraphEditor anEditor,int orientation)
	{
		debug ("create ()");

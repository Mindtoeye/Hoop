...
* 
*/
public class INHoopText2Sentence extends INHoopTransformBase implements INHoopInterface
{    	
	 ...
	 *
	 */
    public INHoopText2Sentence () 
    {
		setClassName ("INHoopText2Sentence");
		debug ("INHoopText2Sentence ()");
	...
	{
		return (new INHoopText2Sentence ());
	}		
}

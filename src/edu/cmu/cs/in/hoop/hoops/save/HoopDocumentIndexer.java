...
* 
*/
public class HoopDocumentIndexer extends HoopSaveBase
{   
	private static final long serialVersionUID = -8495052993868801211L;
	 ...
	 *
	 */
    public HoopDocumentIndexer ()
    {
		setClassName ("HoopDocumentIndexer");
		debug ("HoopDocumentIndexer ()");
												
		setHoopDescription ("Lucene Document Indexer");			
    }
	/**
	 * 
	 */
	 ...
	 * 
	 */
	protected void addToSearchIndex (HoopKVDocument aDocument)
	{
	...
	{
		return (new HoopDocumentIndexer ());
	}		
}

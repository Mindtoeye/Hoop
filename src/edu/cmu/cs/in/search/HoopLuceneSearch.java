 ...
 * 
 */
public class HoopLuceneSearch extends HoopRoot 
{
	/**
	 * 
	 */
	private HoopLuceneSearch() 
	{
		setClassName ("HoopLuceneSearch");
		debug ("HoopLuceneSearch ()");	  
	}
	/**
	 * 
	 */
	public void runSearch (String [] args) throws Exception 
	{
		...
		while (true) 
		{
			...
			debug ("Searching for: " + query.toString(field));
			...
			{                           // repeat & time as benchmark
				...
				debug ("Time: "+(end.getTime()-start.getTime())+"ms");
			}
	...
	{
		HoopLuceneSearch searcher=new HoopLuceneSearch ();
		
		searcher.runSearch(args);
	}
							    ...
							    boolean interactive) throws IOException 
	{
		...
		while (true) 
		{
			if (end > hits.length) 
			{
				debug ("Only results 1 - " + hits.length +" of " + numTotalHits + " total matching documents collected.");

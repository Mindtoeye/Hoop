 ...
 *
 */
public class StagedConfigurationImpl extends HoopRoot implements StagedConfiguration 
{
	private enum Scope 
	{
		STAGE, GLOBAL
	...
	{
		debug ("addComponentIfInGlobalScope ("+scopeName+")");
